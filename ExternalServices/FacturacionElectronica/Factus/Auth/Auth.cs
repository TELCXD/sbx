...
namespace ExternalServices.FacturacionElectronica.Factus.Auth
{
    public class Auth: IAuthService
    {
        public Response<dynamic> Autenticacion(AuthEntitie authEntitie)
        {
        ...
        public Response<dynamic> RefreshToken(AuthEntitie authEntitie)
        {
            var response = new Response<dynamic>();
            try
            {
