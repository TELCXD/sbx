...
namespace sbx
{
    public partial class AgregaProveedor : Form
    {
        ...
        public AgregaProveedor(IProveedor proveedor, IIdentificationType identificationType,
            ITipoResponsabilidad tipoResponsabilidad,
            IResponsabilidadTributaria responsabilidadTributaria, ITipoContribuyente tipoContribuyente,
            IPais pais, IDepartamento departamento, ICiudad ciudad)
        {
            InitializeComponent();
